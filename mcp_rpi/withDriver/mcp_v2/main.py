...
class MainWindow(QMainWindow):
    ...
    def init_buttons(self):
        ...
        self.jogPanel.ui.cleanButton.pressed.connect(lambda: self.handle_button_pressed(CLEAN))
        self.jogPanel.ui.nozzleBoxButton.pressed.connect(
        ...
        self.jogPanel.ui.cleanButton.released.connect(lambda: self.handle_button_released(CLEAN))
        self.jogPanel.ui.nozzleBoxButton.released.connect(
    ...
    def update_button_states(self, EtcInValue):
        ...
        if EtcInValue & CLEAN:
            self.jogPanel.ui.cleanButton.setChecked(True)
        else:
            self.jogPanel.ui.cleanButton.setChecked(False)
        ...
        if EtcInValue & NOZZLE_CHANGE:
            self.jogPanel.ui.nozzleBoxButton.setChecked(True)
        else:
            self.jogPanel.ui.nozzleBoxButton.setChecked(False)
