...
"    }")
        ...
        self.doorUnlockButton = QToolButton(self.layoutWidget_10)
        self.doorUnlockButton.setObjectName(u"doorUnlockButton")
        self.doorUnlockButton.setMinimumSize(QSize(140, 120))
        self.doorUnlockButton.setMaximumSize(QSize(145, 120))
        font3 = QFont()
        font3.setFamilies([u"Exo 2 SemiBold"])
        font3.setPointSize(15)
        font3.setBold(True)
        self.doorUnlockButton.setFont(font3)
        self.doorUnlockButton.setStyleSheet(u"")
        icon4 = QIcon()
        icon4.addFile(u"images/white/ISO_7000_-_Ref-No_3305.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.doorUnlockButton.setIcon(icon4)
        self.doorUnlockButton.setIconSize(QSize(80, 80))
        self.doorUnlockButton.setCheckable(True)
        self.doorUnlockButton.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextUnderIcon)

        self.gridLayout_8.addWidget(self.doorUnlockButton, 6, 0, 1, 1)

        self.nozzleChangeButton = QToolButton(self.layoutWidget_10)
        self.nozzleChangeButton.setObjectName(u"nozzleChangeButton")
        self.nozzleChangeButton.setMinimumSize(QSize(140, 120))
        self.nozzleChangeButton.setMaximumSize(QSize(145, 120))
        self.nozzleChangeButton.setFont(font)
        self.nozzleChangeButton.setStyleSheet(u"")
        icon5 = QIcon()
        icon5.addFile(u"images/white/ISO_7000_-_Ref-No_0024.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon5.addFile(u"images/white/ISO_7000_-_Ref-No_0025.svg", QSize(), QIcon.Mode.Active, QIcon.State.On)
        self.nozzleChangeButton.setIcon(icon5)
        self.nozzleChangeButton.setIconSize(QSize(80, 80))
        self.nozzleChangeButton.setCheckable(True)
        self.nozzleChangeButton.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextUnderIcon)

        self.gridLayout_8.addWidget(self.nozzleChangeButton, 6, 4, 1, 1)
...
"}")
        ...
        font6 = QFont()
        font6.setFamilies([u"Exo 2 ExtraBold"])
        font6.setPointSize(16)
        font6.setBold(True)
        self.jogButton.setFont(font6)
...
"	")
        ...
        self.rightFrame_2.setFont(font4)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.doorUnlockButton.setText(QCoreApplication.translate("MainWindow", u"DOOR", None))
        self.nozzleChangeButton.setText(QCoreApplication.translate("MainWindow", u"NOZZLE", None))
